...
import auth
from models import Base, CertificateType, CertificateIssue
...
def run():
    ...
    with TestClient(app) as client:
        ...
        # create resident
        r = client.post("/api/residents/", json={"first_name": "PDF", "last_name": "Tester"}, headers=headers)
        ...
        # issue certificate
        c = client.post("/api/certificates/", json={"certificate_type_code": "PDFT", "resident_id": resident["id"]}, headers=headers)
